...
import com.jyx.android.camera.open.CameraManager;
import com.jyx.android.decoding.CaptureActivityHandler;
import com.jyx.android.decoding.InactivityTimer;
import com.jyx.android.image.RGBLuminanceSource;
...
public class MipcaActivityCapture extends Activity implements Callback , View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.decoder_capture);
...
//		Button mButtonBack = (Button) findViewById(R.id.button_back);
		...
		TextView back= (TextView) findViewById(R.id.tv_back1);
...
//		mImageButton.setOnClickListener(this);
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case PARSE_BARCODE_SUC:
					uintent((String) msg.obj, scanBitmap);
					break;
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		uintent(resultString, barcode);

	}
	public void uintent(String string,Bitmap bitmap){
		...
		if (substring.equals("1")){
			...
			Intent intent = new Intent(MipcaActivityCapture.this, DecoderActivity.class);

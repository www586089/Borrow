 ...
 */
public class SelectItemTypeAdapter extends RecycleBaseAdapter {
    private Animation animRightIn,animRightOut;//按钮伸缩动画
    private Context context = null;
    private OnCheckClistener listener = null;
    public SelectItemTypeAdapter(Context context) {
    ...
    protected View onCreateItemView(ViewGroup parent, int viewType) {
        return getLayoutInflater(parent.getContext()).inflate(R.layout.list_cell_select_item_type, null);
    }

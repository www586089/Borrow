...
import com.jyx.android.adapter.chat.RentalGroupMessageAdapter;
 ...
 */
public class RentalGroupFragment  extends AbsBaseRentalFragment {
    ...
    protected void initAdapter() {
        if (null == rentalAdapter) {
            rentalAdapter = new RentalGroupMessageAdapter(getActivity(),this);
    ...
    void getGroupRental(final GroupInfoBean bean, final int size) {

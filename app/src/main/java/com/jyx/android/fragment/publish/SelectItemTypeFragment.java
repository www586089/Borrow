 ...
 */
public class SelectItemTypeFragment extends BaseRecycleViewFragment {

    private SelectItemTypeAdapter listAdapter = null;
    protected static final String TAG = SelectItemTypeFragment.class.getSimpleName();
    ...
    private SelectItemTypeAdapter.OnCheckClistener onCheckClistener = new SelectItemTypeAdapter.OnCheckClistener() {
        @Override
    ...
    protected RecycleBaseAdapter getListAdapter() {
        if (null == listAdapter) {
            listAdapter = new SelectItemTypeAdapter(this.getActivity());
    ...
    protected void sendRequestData() {
        ...
        /*AVQuery.doCloudQueryInBackground("select * from itemType limit " + Integer.toString(index) + ",20 order by updatedAt desc", new CloudQueryCallback<AVCloudQueryResult>() {
            @Override

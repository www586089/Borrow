...
//        }
    ...
    private static class ParserComTask extends AsyncTask<Void, Void, String> {
        private WeakReference<BaseListFragment> mInstance;
...
//        }
        ...
        public ParserComTask(BaseListFragment instance,  List<?> listobjs, boolean fromCache) {
            this.mInstance = new WeakReference<>(instance);
        ...
        protected String doInBackground(Void... params) {
            BaseListFragment instance = mInstance.get();

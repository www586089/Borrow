 ...
 */
public class ApplyGroupAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    List<ConversationInfo> conversationInfoList ;
    Context context;
    public ApplyGroupAdapter(List<ConversationInfo> list, Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ConversationInfo info = conversationInfoList.get(position);

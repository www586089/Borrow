...
public class UIButton extends LinearLayout {
	...
	public UIButton(Context context, AttributeSet attrs) {
		...
		mTitle = a.getString(R.styleable.UIButton_UIBtntitle);
		mSubtitle = a.getString(R.styleable.UIButton_UIBtnsubtitle);
		mImage = a.getResourceId(R.styleable.UIButton_UIBtnimage, -1);
